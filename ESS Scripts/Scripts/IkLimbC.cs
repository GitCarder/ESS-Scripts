...
public class IkLimbC : MonoBehaviour {
	...
	void CalculateIK(){
		...
		// Obtain the rotation around the z axis and change it in upperArmStartRotation. Everything else the same 
		//var temp : Vector3 = Vector3(1,1,1);
		//var upArmRot : Vector3 = upperArmStartRotation.eulerAngles;
		//var uAr : Vector3 = upperArm.rotation.eulerAngles;
		//upArmRot.z = uAr.z;
		//upperArmStartRotation = Quaternion.Euler(upArmRot);
		...
		Vector3 upArmAxisCorr = upperArmAxisCorrection.transform.localRotation.eulerAngles;
		upArmAxisCorr.x = upArmAxisCorr.x - ikAngle;
		upperArmAxisCorrection.transform.localRotation = Quaternion.Euler(upArmAxisCorr);
		//upperArmAxisCorrection.transform.localRotation.eulerAngles.x = upperArmAxisCorrection.transform.localRotation.eulerAngles.x - ikAngle;
